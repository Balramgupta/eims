		...
		<div class="card">
          <div class="card-header">
            <div class="col-md-12">
            	<div class="row">
	                <div class="col-md-6">
	                    <h3 class="card-title pt-2">Edit Deportment</h3>
	                </div>
	                <div class="col-md-6">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{route('admin.examination.deportment.update', $deportment->id)}}" method="post">
          	@csrf
            @method('put')
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" class="form-control"  value="{{$deportment->title}}">
                    @error('title')
                  	<code>{{$message}}</code>
                  	@enderror
                  </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="type" name="type" class="form-control" value="{{$deportment->type}}">
                    @error('type')
                    <code>{{$message}}</code>
                    @enderror
                  </div>
