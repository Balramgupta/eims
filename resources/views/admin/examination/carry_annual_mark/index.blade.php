	...
	<div class="col-md-12 col-lg-12">
		<div class="card">
            ...
            <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6">
                    <h3 class="card-title pt-2">Carry Annual Mark List</h3>
                  </div>
                  <div class="col-md-6 text-right">
                    <a href="{{route('admin.examination.carry_annual_mark.create')}}" class="btn btn-primary float-right"><i class="fas fa-share-square"></i> Carry Annual Mark</a>
                  </div>
                </div>
            </div>
          </div>
			<div class="card-body p-0">
				<div class="table-responsive">
					<table class="table table-striped card-table table-vcenter text-nowrap mb-0">
						...
						<tbody>
							@foreach($carryAnnualMark as $key=>$carryAnnualMark)
							<tr>
								<th scope="row">{{$key+1}}</th>
								<td>{{$carryAnnualMark['term']['name']}}</td>
								<td>{{$carryAnnualMark->carry_percent}}</td>
								<td>
