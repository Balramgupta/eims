		...
		<div class="card">
          <div class="card-header">
            <div class="col-md-12">
            	<div class="row">
	                <div class="col-md-6">
	                    <h3 class="card-title pt-2">Create Test</h3>
	                </div>
	                <div class="col-md-6">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{route('admin.examination.test.store')}}" method="post">
          	@csrf
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="Name" name="name" class="form-control" placeholder="Enter Test Name" value="{{old('name')}}">
                    @error('name')
                	<code>{{$message}}</code>
                	@enderror
                  </div>
