...
<div class="row">
	<div class="col-md-12">
		<div class="card">
            ...
            <div class="col-md-12">
            	<div class="row">
	                ...
	                <div class="col-md-6 text-right">
	                  <a href="{{route('admin.examination.test_to_term')}}" class="btn btn-primary float-right"><i class="fas fa-list"></i> Carry Term List</a>
	                </div>
	            </div>
            </div>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{route('admin.examination.test_to_term.update', $testToTerm->id)}}" method="post">
          	@csrf
            @method('put')
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text" id="carry_percent" name="carry_percent" class="form-control" value="{{$testToTerm->carry_percent}}">
                    @error('carry_percent')
                    <code>{{$message}}</code>
                    @enderror
                  </div>
