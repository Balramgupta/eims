		...
		<div class="card">
          <div class="card-header">
            <div class="col-md-12">
            	<div class="row">
	                <div class="col-md-6">
	                    <h3 class="card-title pt-2">Create Assign Deportment Class</h3>
	                </div>
	                <div class="col-md-6 text-right">
	                  <a href="{{route('admin.examination.assign_deportment_class')}}" class="btn btn-primary float-right"><i class="fas fa-list"></i> Assign Deportment Class List</a>
	                </div>
	            </div>
            </div>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{route('admin.examination.assign_deportment_class.store')}}" method="post" enctype="multipart/form-data">
          	@csrf
            <div class="add_item">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="term_id">Term <code>*</code></label>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="deportment_id">Deportment Title <code>*</code></label>
                    <select name="deportment_id" class="multi-select" id="deportment_id" multiple="multiple">
                      @foreach($deportment as $deportment)
                      <option value="{{$deportment->id}}">{{$deportment->title}}</option>
                      @endforeach
                    </select>
                    @error('deportment')
                    <code>{{$message}}</code>
