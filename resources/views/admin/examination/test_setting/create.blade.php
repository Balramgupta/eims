		...
		<div class="card">
          <div class="card-header">
            <div class="col-md-12">
            	<div class="row">
	                <div class="col-md-6">
	                    <h3 class="card-title pt-2">Create Test Setting</h3>
	                </div>
	                <div class="col-md-6 text-right">
	                  <a href="{{route('admin.examination.test_setting')}}" class="btn btn-primary float-right"><i class="fas fa-list"></i> Test Setting List</a>
	                </div>
	            </div>
            </div>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{route('admin.examination.test_setting.store')}}" method="post" enctype="multipart/form-data">
          	@csrf
            <div class="card-body">
            <div class="add_item">
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="test_id">Select Test <code>*</code></label>
