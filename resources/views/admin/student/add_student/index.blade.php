        ...
        <div class="card">
          <div class="card-header">
            <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6">
                    <h3 class="card-title pt-2">Student List</h3>
                  </div>
                  <div class="col-md-6 text-right">
                    <a href="{{route('admin.student.add_student.create')}}" class="btn btn-primary float-right"><i class="fas fa-share-square"></i> Create Student Level</a>
                  </div>
                </div>
            </div>
          </div>
              ...
              <tbody>
                @foreach($students as $key => $student)
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#detail-modal{{$student->id}}"><i class="fas fa-eye"> View</button>
                          ...
                          <div class="modal-header">
                            ...
                            <div class="modal-body">
                              <div class="row">
                                ...
                                <div class="col-md-3 list-group-item">
                                  <b>Section</b>
                                  <p>{{$student['assign_section_class']['section_name']}}</p>
                                </div>
                                <div class="col-md-3 list-group-item">
