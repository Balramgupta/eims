	...
	<div class="col-md-12 col-lg-12">
		<div class="card">
            ...
            <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6">
                    <h3 class="card-title pt-2">Class List</h3>
                  </div>
                  <div class="col-md-6 text-right">
                    <a href="{{route('admin.class.create')}}" class="btn btn-primary float-right"><i class="fas fa-share-square"></i> Create Class</a>
                  </div>
                </div>
            </div>
          </div>
			<div class="card-body p-0">
				<div class="table-responsive">
					<table class="table table-striped card-table table-vcenter text-nowrap mb-0">
						...
						<tbody>
							@foreach($studentClass as $key=>$studentClass)
							<tr>
								<th scope="row">1</th>
								<td>{{$studentClass['level']['name']}}</td>
								<td>{{$studentClass['faculty']['name']}}</td>
