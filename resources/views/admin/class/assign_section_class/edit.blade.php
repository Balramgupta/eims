		...
		<div class="card">
          <div class="card-header">
            <div class="col-md-12">
            	<div class="row">
	                <div class="col-md-6">
	                    <h3 class="card-title pt-2">Edit Assign Section to Class</h3>
	                </div>
          ...
          <!-- /.card-header -->
          <!-- form start -->
        <form role="form" action="{{route('admin.class.assign_section_class.update', $editData[0]->class_id)}}" method="post">
          	@csrf
          	@method('PUT')
            <div class="card-body">
	            <div class="add_item">
	              	<div class="row">
		                  ...
		                  <div class="form-group">
		                	...
		                	<select name="level_id" class="form-control" id="level_id">
	            				...
	            				<option value="{{$level->id}}" {{($editData[0]->level_id == $level->id) ?"selected" : ""}}>
	            					{{$level->name}}
	            				</option>
	            				@endforeach
	            			</select>
		                ...
		                <div class="col-sm-4">
		                  <div class="form-group">
		                    ...
		                    <select name="faculty_id" class="form-control" id="faculty_id">
	            				...
	            				<option value="{{$faculty->id}}" {{($editData[0]->faculty_id == $faculty->id) ?"selected" : ""}}>
	            					{{$faculty->name}}
	            				</option>
	            				@endforeach
	            			</select>
		                ...
		                <div class="col-sm-4">
		                  <div class="form-group">
		                    ...
		                    <select name="class_id" class="form-control" id="class_id">
	            				...
	            				<option value="{{$StudentClass->id}}" {{($editData[0]->class_id == $StudentClass->id) ?"selected" : ""}}>
            		...
            		<div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
	            		<div class="form-row">
		            		<div class="form-group col-md-6">
		            			...
		            			<input type="text" id="section_name" name="section_name[]" class="form-control" value="{{$edit->section_name}}">
		                        @error('section_name')
			                	<code>{{$message}}</code>
			                	@enderror
		            		</div>
