		...
		<div class="card">
          <div class="card-header">
            <div class="col-md-12">
            	<div class="row">
	                <div class="col-md-6">
	                    <h3 class="card-title pt-2">Edit Faculty</h3>
	                </div>
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{route('admin.class.faculty.update',$faculty->id)}}" method="post">
          	@csrf
            @method('put')
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" placeholder="Enter Faculty Name" value="{{$faculty->name}}">
                    @error('name')
                	<code>{{$message}}</code>
                	@enderror
                  </div>
