		...
		<div class="card">
          <div class="card-header">
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-6">
                    <h3 class="card-title pt-2">Edit Subject</h3>
                </div>
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{route('admin.subject.update',$subject->id)}}" method="post">
          	@csrf
          	@method('put')
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-level">
                    ...
                    <input type="text" id="subject_name" name="subject_name" class="form-control"  value="{{$subject->subject_name}}">
                    @error('subject_name')
                  	<code>{{$message}}</code>
                  	@enderror
                    </div>
